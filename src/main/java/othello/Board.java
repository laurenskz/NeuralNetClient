...
public class Board {
    ...
    private int board[][];
    private Game game;
    private Point[][] possibleMoveCache = new Point[3][];
    ...
    public Point[] getPossibleMoves(int player) {
        if(possibleMoveCache[player]!=null)return possibleMoveCache[player];
